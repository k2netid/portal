...
import ThemePreview from '@/modules/Content/Layout/components/themes/ThemePreview.vue';
import ThemeCardLivePreview from '@/modules/Content/Layout/components/themes/ThemeCardLivePreview.vue';
