...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Define custom paths that laravel-modules will scan recursively.
    |
    */
    'scan' => [
        'enabled' => true,
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'jejakawan'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Jejakawan'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'hello@jejakawan.com'),
        ],
