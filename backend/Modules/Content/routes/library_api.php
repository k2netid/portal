...
use Modules\Content\Library\Http\Controllers\Api\CategoryController;
use Modules\Content\Library\Http\Controllers\Api\CustomFieldController;
use Modules\Content\Library\Http\Controllers\Api\FieldGroupController;
use Modules\Content\Library\Http\Controllers\Api\TagController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::prefix('manage/library')->middleware(['auth:sanctum'])->group(function (): void {
