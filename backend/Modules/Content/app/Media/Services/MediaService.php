...
namespace Modules\Content\Media\Services;
...
use Modules\Content\Media\Models\DeletedFile;
use Modules\Content\Media\Models\File;
use Modules\Content\Media\Models\Folder;
use Modules\Content\Media\Models\Usage;
...
class MediaService implements MediaServiceInterface
{
     ...
     */
    public function moveVariantsToTrash(File $media, string $trashPath): void
    {
     ...
     */
    public function moveVariantsFromTrash(File $media, string $trashPath, string $restoredPath): void
    {
        unset($trashPath, $restoredPath);
     ...
     * Delete media.
     */
    public function delete(File $file, bool $permanent = false, bool $unlinkPhysical = true): void
    {
        if ($permanent) {
            if ($unlinkPhysical) {
