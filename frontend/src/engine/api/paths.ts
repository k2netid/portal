...
export const platformPaths = {
    ...
    index: '/manage/platform',
    packages: '/manage/platform/packages',
    package: (id: string) => `/manage/platform/packages/${id}`,
    subscriptions: '/manage/platform/subscriptions',
    subscription: (id: string) => `/manage/platform/subscriptions/${id}`,
    subscriptionMembers: (id: string) => `/manage/platform/subscriptions/${id}/members`,
    subscriptionAksaraPush: (id: string) => `/manage/platform/subscriptions/${id}/aksara-push`,
    transactions: '/manage/platform/transactions',
    checkout: (id: string) => `/manage/platform/transactions/${id}/checkout`,
    webhookDeliveries: (id: string) => `/manage/platform/transactions/${id}/webhook-deliveries`,
    webhookDeliveriesFailed: '/manage/platform/webhook-deliveries/failed',
    retryWebhookDelivery: (id: string) => `/manage/platform/webhook-deliveries/${id}/retry`,
    markRefunded: (id: string) => `/manage/platform/transactions/${id}/mark-refunded`,
    markPaid: (id: string) => `/manage/platform/transactions/${id}/mark-paid`,
    reconciliation: '/manage/platform/reconciliation',
} as const;

export const accountingPaths = {
    journals: '/manage/accounting/journals',
    journal: (id: string | number) => `/manage/accounting/journals/${id}`,
    accounts: '/manage/accounting/accounts',
    reconciliation: '/manage/accounting/reconciliation',
    reconciliationExport: '/manage/accounting/reconciliation/export',
    trialBalance: '/manage/accounting/reports/trial-balance',
    trialBalanceExport: '/manage/accounting/reports/trial-balance/export',
    invoices: '/manage/accounting/invoices',
    invoice: (id: string | number) => `/manage/accounting/invoices/${id}`,
    invoiceMarkSent: (id: string | number) => `/manage/accounting/invoices/${id}/mark-sent`,
    invoicePdf: (id: string | number) => `/manage/accounting/invoices/${id}/pdf`,
    invoiceMarkPaid: (id: string | number) => `/manage/accounting/invoices/${id}/mark-paid`,
    invoiceMarkRefunded: (id: string | number) => `/manage/accounting/invoices/${id}/mark-refunded`,
    expenses: '/manage/accounting/expenses',
    expense: (id: string | number) => `/manage/accounting/expenses/${id}`,
    expenseSummary: '/manage/accounting/expenses/summary',
    fiscalPeriods: '/manage/accounting/fiscal-periods',
    fiscalPeriodClose: (id: string | number) => `/manage/accounting/fiscal-periods/${id}/close`,
    sptPpnExport: '/manage/accounting/reports/spt-ppn/export',
} as const;

export const crmPaths = {
    accounts: '/crm/accounts',
    account: (id: string | number) => `/crm/accounts/${id}`,
    contacts: '/crm/contacts',
    contact: (id: string | number) => `/crm/contacts/${id}`,
    leads: '/crm/leads',
    lead: (id: string | number) => `/crm/leads/${id}`,
    activities: '/crm/activities',
    activity: (id: string | number) => `/crm/activities/${id}`,
    opportunities: '/crm/opportunities',
    opportunity: (id: string | number) => `/crm/opportunities/${id}`,
    tickets: '/crm/tickets',
    ticket: (id: string | number) => `/crm/tickets/${id}`,
    ticketReplies: '/crm/ticket-replies',
    ticketReply: (id: string | number) => `/crm/ticket-replies/${id}`,
    aiSettings: '/crm/ai/settings',
    aiDraftTicketReply: '/crm/ai/draft-ticket-reply',
    aiAnalyzeSentiment: '/crm/ai/analyze-sentiment',
    assignees: '/crm/assignees',

    reportsSummary: '/crm/reports/summary',
    recordHistory: (entity: string, id: string | number) => `/crm/records/${entity}/${id}/history`,
    bulk: (entity: string) => `/crm/bulk/${entity}`,
    opportunityStage: (id: string | number) => `/crm/opportunities/${id}/stage`,

    forecast: '/crm/forecast',
    pipelines: '/crm/pipelines',
    pipeline: (id: string | number) => `/crm/pipelines/${id}`,
    customFields: '/crm/custom-field-definitions',
    customField: (id: string | number) => `/crm/custom-field-definitions/${id}`,
    recordCustomFields: (entityType: string, entityId: string | number) => `/crm/records/${entityType}/${entityId}/custom-fields`,
    workflows: '/crm/workflows',
    workflow: (id: string | number) => `/crm/workflows/${id}`,
    sequences: '/crm/sequences',
    sequence: (id: string | number) => `/crm/sequences/${id}`,
    sequenceEnroll: (id: string | number) => `/crm/sequences/${id}/enroll`,
    leadConvert: (id: string | number) => `/crm/leads/${id}/convert`,
    exportEntity: (entity: string) => `/crm/export/${entity}`,
} as const;
