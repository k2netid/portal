  ...
  <div class="bg-transparent p-4 shadow-none h-full overflow-y-auto">
    <div class="flex items-center justify-between mb-6 pb-4 border-b">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-lg font-bold tracking-tight">
            {{ $t('media.file_manager.trash.title') }}
          </h2>
      ...
      <div class="flex items-center gap-2">
        ...
        >
          ...
          />
          {{ $t('media.file_manager.trash.refresh') }}
        </Button>
        <Button
          variant="destructive"
          size="sm"
    ...
    >
      ...
      <p class="text-sm font-medium animate-pulse">
        {{ $t('media.file_manager.trash.scanning') }}
      </p>
    </div>
    ...
    >
      ...
      <h3 class="text-lg font-bold text-foreground/90">
        {{ $t('media.file_manager.trash.emptyTitle') }}
      </h3>
      <p class="text-sm text-muted-foreground max-w-[280px] mt-2">
        {{ $t('media.file_manager.trash.emptyDescription') }}
      </p>
    </div>
