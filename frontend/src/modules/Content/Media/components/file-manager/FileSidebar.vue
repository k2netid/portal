  ...
  >
    ...
    >
      <h2 class="text-xs font-semibold text-foreground/70 flex items-center">
        ...
        {{ $t('media.file_manager.labels.folders') }}
      </h2>
    </div>
        ...
        <ContextMenu>
          <ContextMenuTrigger as-child>
            ...
            >
              ...
              />
              <span class="truncate font-medium">{{ $t('media.file_manager.nav.root') }}</span>
            </button>
          </ContextMenuTrigger>
    ...
    >
      ...
      >
        ...
        />
        <span class="truncate font-semibold tracking-tight">{{ $t('media.file_manager.trash.title') }}</span>
