    ...
    >
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <div class="flex justify-between text-xs">
              <span class="text-muted-foreground">{{ t('media.file_manager.properties.type') }}</span>
            ...
            >
              <span class="text-muted-foreground">{{ t('media.file_manager.properties.size') }}</span>
              <span class="font-medium">{{ formatFileSize(activeFile.size) }}</span>
            </div>
            <div class="flex justify-between text-xs">
              <span class="text-muted-foreground">{{ t('media.file_manager.properties.modified') }}</span>
      ...
      >
        ...
        <p class="text-sm font-medium">
          {{ t('media.file_manager.properties.select_item') }}
        </p>
      </div>
    </div>
  </div>
