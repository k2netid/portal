...
class="console-dialog-lg"
    ...
    >
      <DialogHeader>
        <DialogTitle>{{ $t('media.file_manager.modals.upload.title') }}</DialogTitle>
        <DialogDescription>
          {{ $t('media.file_manager.modals.upload.placeholder') }}
        </DialogDescription>
      </DialogHeader>
      ...
      <div class="py-4">
        ...
        >
          ...
          <div class="text-sm text-muted-foreground">
            <span class="text-primary font-bold group-hover/upload:underline">
              {{ $t('media.file_manager.modals.upload.clickToUpload') }}
            </span>
            {{ $t('media.file_manager.modals.upload.dragAndDrop') }}
          </div>
          <p class="mt-2 text-xs text-muted-foreground font-medium">
            {{ $t('media.file_manager.modals.upload.formats') }}
          </p>
        </div>
        ...
        >
          <h4 class="text-xs font-semibold text-foreground/70 mb-3 flex items-center justify-between">
            <span>{{ $t('media.file_manager.modals.upload.selectedFiles') }}</span>
        ...
        >
          <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-bold text-primary uppercase tracking-widest">{{ $t('media.file_manager.modals.upload.uploading') }}</span>
      ...
      <DialogFooter>
        ...
        >
          {{ $t('media.file_manager.modals.upload.cancel') }}
        </Button>
        <Button
        ...
        >
          ...
          />
          {{ uploading ? $t('media.file_manager.modals.upload.uploading') : $t('media.file_manager.modals.upload.uploadAction', { count: selectedFiles.length }) }}
        </Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
