...
const definition: MenuItemDefinition = {
    name: 'post',
    label: 'layout.menus.form.types.post',
    category: 'content',
    icon: File,
    color: 'orange',
    ...
    dataSource: {
        endpoint: '/manage/publishing/contents?type=post&status=published',
        labelField: 'title',
        valueField: 'id'
    },
    ...
    settings: [
        ...
        },
        {
            key: 'target_id',
            type: 'data_select',
            label: 'layout.menus.form.selectPost',
            required: true,
            source: '/manage/publishing/contents?type=post&status=published',
            labelField: 'title',
            valueField: 'id'
        },
        {
