import type { CustomizerSettingsSchema } from '@/modules/Content/Layout/customizer/types/customizer-schema';
import platformSchemaJson from '@/modules/Content/Layout/customizer/platform/schema/global.settings.schema.json';

const themeSchemaModules = import.meta.glob(
    '@/modules/Content/Layout/views/themes/*/customizer/schema.settings.json',
    { eager: true },
