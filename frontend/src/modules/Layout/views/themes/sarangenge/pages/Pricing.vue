      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 w-full text-center">
        ...
        <div class="sarangenge-panel p-8 md:p-12 bg-[var(--sarangenge-teal,#0f766e)]/5 border-[var(--sarangenge-teal,#0f766e)]/20 shadow-lg">
          ...
          <p class="text-muted-foreground mb-8">
            Tidak ada pungutan Sumbangan Pembinaan Pendidikan (SPP) bulanan maupun Uang Bangunan. Semua proses penerimaan peserta didik baru dan kegiatan akademik reguler difasilitasi oleh negara.
          </p>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-8">
            <div class="space-y-3">
              <div class="flex items-start gap-3">
                <Check class="w-5 h-5 text-green-600 mt-0.5" />
                <span class="text-sm font-medium">Bebas SPP Bulanan (Ditanggung BOPD Jabar)</span>
              </div>
              <div class="flex items-start gap-3">
                <Check class="w-5 h-5 text-green-600 mt-0.5" />
                <span class="text-sm font-medium">Bebas Uang Pangkal / Uang Gedung</span>
              </div>
            </div>
            <div class="space-y-3">
              <div class="flex items-start gap-3">
                <Check class="w-5 h-5 text-green-600 mt-0.5" />
                <span class="text-sm font-medium">Bantuan Operasional Sekolah (BOS) Pusat</span>
              </div>
              <div class="flex items-start gap-3">
                <Check class="w-5 h-5 text-green-600 mt-0.5" />
                <span class="text-sm font-medium">Fasilitas Praktik Standar Industri SMK PK</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="sarangenge-panel p-8 text-center space-y-6">
          ...
          <p class="text-muted-foreground text-sm max-w-xl mx-auto">
            Proses seleksi dan pendaftaran PPDB SMK Negeri 6 Bandung dilaksanakan secara terpusat melalui portal resmi Dinas Pendidikan Provinsi Jawa Barat.
          </p>
          <a
            :href="ppdbPortalUrl"
            target="_blank"
