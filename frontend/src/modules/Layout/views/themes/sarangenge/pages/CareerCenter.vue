    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 w-full">
      <div class="text-center space-y-4">
        <h1 class="text-4xl sm:text-5xl font-extrabold text-foreground font-heading">
          {{ t('theme.sarangenge.pages.career_center.title', 'Join Our Team') }}
        </h1>
        <p class="text-lg text-muted-foreground">
          {{ t('theme.sarangenge.pages.career_center.subtitle', 'Build the future of digital publishing with us.') }}
        </p>
      </div>
